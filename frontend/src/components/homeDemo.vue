<template>
    ...
    <link rel="stylesheet" href="../src/assets/fonts/style.css" />
            ...
            <div class="main-slider slider slick-initialized slick-slider">
                    <div  class="slider-item" :style="{ 'background-image': 'url(' + require('@/assets/images/f-2.jpg') + ')' }">
                        <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-12 offset-lg-0 offset-md-6">
                            <div class="slider-caption">
                                <!-- <span class="lead">Trendy dress</span> -->
                                <h1 class="mt-2 mb-5"><span class="text-color">Furnish on</span>Rent</h1>
                                <a href="#" class="btn btn-main">Rent Now</a>
                            </div>
                            </div>
                        </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-4 col-sm-12 col-md-6">
                    ...
                    <img src="../assets/images/image-570x300.jpg" style="max-width: 100%; height: auto;" alt=""  class="img-fluid w-100 mb-3" /></div>
                    <div class="item-info">
                        <p class="mb-0">Prestige Gas Stove </p>
                        <h4 class="mb-4">up to <strong>50% </strong>off</h4>
  
                        <a href="#" class="read-more">Rent Now</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-12 col-md-6">
                    <div class="cat-item mb-4 mb-lg-0">
                    <img src="../assets/images/couch11.jpg" alt="" class="img-fluid w-100 mb-3" /></div>
  
                    <div class="item-info">
                        <p class="mb-0">Grey Couch</p>
                ...
                <div class="col-lg-4 col-sm-12 col-md-6">
                    <div class="cat-item">
                    <img src="../assets/images/acc.jpg" alt="" class="img-fluid w-100 mb-3" /></div>
                    <div class="item-info">
            ...
            <section class="section products-main">
                ...
                <div class="row">
                    <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5" >
                        ...
                        <div class="product-wrap">
                            <a href="/productdetails"><img class="img-fluid w-100 mb-3" src="../assets/images/fridge.jpg" alt="product-img" /></a>
                            <!-- <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/fridge.jpg" alt="product-img" /></a> -->
                        </div>
            
                        <span class="onsale">Sale</span>
            
                        <div class="product-info">
                            <h2 class="product-title h5 mb-0"><a href="#">Samsung fridge</a></h2>
                            <span class="price">
                                $50.00/month
                            </span>
                        </div>
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/geyser.jpg" alt="product-img" /></a>
                            <!-- <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/geyser.jpg" alt="product-img" /></a> -->
                        </div>
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/washing.jpg" alt="product-img" /></a>
                            <!-- <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/washing.jpg" alt="product-img" /></a> -->
                        </div>
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/sofa.jpg" alt="product-img" /></a>
                            <!-- <a href="/productdetails"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/sofa.jpg" alt="product-img" /></a> -->
                        </div>
                        <div class="product-info">
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/cupboard.jpg" alt="product-img" /></a>
                            <!-- <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/cupboard.jpg" alt="product-img" /></a> -->
                        </div>
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/study.jpg" alt="product-img" /></a>
                            <!-- <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/study.jpg" alt="product-img" /></a> -->
                        </div>
                        <div class="product-info">
                    ...
                    <div class="product">
                        <div class="product-wrap">
                            <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/dining.jpg" alt="product-img" /></a>
                            <!-- <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/dining.jpg" alt="product-img" /></a> -->
                        </div>
                ...
                <div class="col-lg-3 col-12 col-md-6 col-sm-6 mb-5 " >
                    <div class="product">
                        <div class="product-wrap">
                            <a href="#"><img class="img-fluid w-100 mb-3 img-first" src="../assets/images/bed.jpg" alt="product-img" /></a>
                            <!-- <a href="#"><img class="img-fluid w-100 mb-3 img-second" src="../assets/images/bed.jpg" alt="product-img" /></a> -->
                        </div>
                        <div class="product-info">
            ...
            <div class="container">
                ...
                <div class="col-lg-6 offset-lg-6">
                    ...
                    <a href="#" class="btn btn-main"><i class="ti-bag mr-2"></i>Rent Now </a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    ...
                    <h4 class="mb-4 pb-3">Best selllers</h4>
                            ...
                            <div class="media mb-3">
                                ...
                                <img src="../assets/images/fan.jpg" alt="Product thumb"  class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Keds - Kickstart Pom Pom</a></h6>
                                <p class="featured-entry-meta">$42.99/month</p>
                            </div>
                            </div>
  
                            <div class="media mb-3">
                                <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/table.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Nike - Brasilia Medium Backpack</a></h6>
                                <p class="featured-entry-meta">$27.99/month</p>
                            </div>
                            </div>
  
                            <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/sidetable.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                            ...
                            <div class="media mb-3">
                                <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/gamingchair.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Adidas Originals Cap</a></h6>
                                <p class="featured-entry-meta">$35.00/month</p>
                            </div>
                            </div>
  
                            <div class="media">
                                <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/dishwasher.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Big Star Flip Tops</a></h6>
                                <p class="featured-entry-meta">$10.60/month</p>
                            </div>
                            </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    ...
                    <h4 class="mb-4 pb-3">New Arrivals</h4>
                            ...
                            <div class="media mb-3">
                                <a class="featured-entry-thumb" href="/productdetails">
                                <img src="../assets/images/bed150x150.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Keds - Kickstart Pom Pom</a></h6>
                                <p class="featured-entry-meta">$42.99/month</p>
                            ...
                            <div class="media mb-3">
                                <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/elegeyser150x150.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Nike - Brasilia Medium Backpack</a></h6>
                                <p class="featured-entry-meta">$27.99/month</p>
                            ...
                            <div class="media mb-3">
                            <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/lamp150x150.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Guess - GU7295</a></h6>
                                <p>$38.00/month</p>
                            ...
                            <div class="media mb-3">
                                <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/cabinet150x150.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Adidas Originals Cap</a></h6>
                                <p class="featured-entry-meta">$35.00/month</p>
                            ...
                            <div class="media">
                                <a class="featured-entry-thumb" href="#">
                                <img src="../assets/images/fan.jpg" alt="Product thumb" width="64" class="img-fluid w-50 mb-3" />
                            </a>
                            <div class="media-body">
                                <h6 class="featured-entry-title mb-0"><a href="#">Big Star Flip Tops</a></h6>
                                <p class="featured-entry-meta">$10.60/month</p>
...
.page-header {
  ...
  background-image: url('../assets/images/header-bg.jpg') no-repeat 50% 50%;
...
.ads {
  ...
  background-image: url('@/assets/images/f-000.jpg');
  /* background: url("../images/f-000.jpg") no-repeat; */
  background-size: cover;
  position: relative;
}
