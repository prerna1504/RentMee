...
<template>
    ...
    <link rel="stylesheet" href="../src/assets/fonts/style.css" />
      <!-- <div class="row">
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="card">
            <img class="card-img-top" v-bind:src="product.imageUrl" alt="Product Image" style="width: 312px; height: 400px;align-items: center;">
            <div class="card-body">
              <h1 class="card-title">{{ product.name }}</h1>
              <h3 class="card-text">${{ product.price }}</h3>
              <p class="card-text">Average rating: {{ product.averageRating }}</p>
              <button class="btn btn-primary btn-block" id="add-to-cart" v-on:click="addToCart">Add to cart</button>
                   ...
                   <div class="row">
                       ...
                       <div class="single-product-slider">
                           ...
                           <div class="carousel-inner">
                               ...
                               <img src="src/assets/images/product-3.jpg" alt="" class="img-fluid" />
                               </div>
                               <div class="carousel-item">
                               <img src="src/assets/images/product-2.jpg" alt="" class="img-fluid" />
                               </div>
                               <div class="carousel-item ">
                               <img src="src/assets/images/product-1.jpg" alt="" class="img-fluid" />
                               </div>
                           </div>
                       ...
                       <div class="single-product-details mt-5 mt-lg-0">
                           ...
                           SKU: <span class="text-muted">{{product._id}} </span>
                           </div>
               
                           <hr/>
                           
                           <h3 class="product-price"><del>$300</del> ${{ product.price }}</h3>
                           ...
                           <div class="quantity d-flex align-items-center">
                               ...
                               <a href="#" class="btn btn-main btn-small" v-on:click="addToCart">Add to cart</a>
                           </div>
                           </form> -->
                   ...
                   <div class="row">
                       ...
                       <div class="tab-content" id="nav-tabContent">
                           ...
                           <div class="col-lg-7">
                               ...
                               <img src="src/assets/images/avater-1.jpg" alt="reviewimg" class="img-fluid mr-4" />
                               ...
                               <img src="src/assets/images/avater-2.jpg" alt="reviewimg" class="img-fluid mr-4" />
                               <div class="media-body">
                                   <div class="product-review">
                                   <span><i class="tf-ion-android-star"></i></span>
                                   <span><i class="tf-ion-android-star"></i></span>
        ...
        <section class="products related-products section">
                   ...
                   <div class="row">
                       <div class="col-lg-3 col-6" >
                           ...
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/322.jpg" alt="product-img" /></a>
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/444.jpg" alt="product-img" /></a>
                           </div>
                       ...
                       <div class="col-lg-3 col-6" >
                               <div class="product">
                           <div class="product-wrap">
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/111.jpg" alt="product-img" /></a>
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/222.jpg" alt="product-img" /></a>
                           </div>
                       ...
                       <div class="col-lg-3 col-6" >
                           ...
                           <div class="product-wrap">
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/111.jpg" alt="product-img" /></a>
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/322.jpg" alt="product-img" /></a>
                           </div>
                       ...
                       <div class="col-lg-3 col-6">
                               <div class="product">
                           <div class="product-wrap">
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-first" src="src/assets/images/444.jpg" alt="product-img" /></a>
                           <a routerLink="/product-single"><img class="img-fluid w-100 mb-3 img-second" src="src/assets/images/222.jpg" alt="product-img" /></a>
                           </div>
  ...
  export default {
    ...
    methods:{
      // async addToCart(){
      //   await axios.post(`http://localhost:4242/users/12345/cart`,{
    ...
    async created() {
      try{
      const response = await axios.get(`http://localhost:4242/products/${this.$route.params.id}`);
